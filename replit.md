...
3.  **Promotions Engine**: A simplified config-driven system in `client/src/data/promotions.ts`. Supports commitment bonuses (1-year: +1mo, 2-year: +2mo), pay-in-full doubling, 25th anniversary enrollment bonus, and referral bonus (+1mo). No month-to-month option — minimum 12-month terms only.
