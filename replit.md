...
17. **Unified Terminology**: All customer-facing text uses "Bundled Upgrades" (not "Basic Upgrades" or "Add-ons"). Conversion text says "2 Bundled → 1 Premium". CTAs consistently say "See My Instant Price" (primary) and "Design Your Lawn Plan" (secondary). Wizard header says "See Your Instant Price". Submit button says "See My Instant Price".
18. **Plan Badges**: Premium cards show "Most Popular" badge, Executive cards show "Best Value" badge. Purely presentational. **Birthday Bonus** badges on each plan card with "Celebrating 25 years of Lawn Trooper" tagline: Basic/Premium get +1 Bundled Upgrade, Executive gets +1 Premium Upgrade.
...
35. **Simplified Plan Cards**: Plan cards show "Includes X Bundled Upgrades" / "+ X Premium Upgrades" counts instead of listing specific pre-selected upgrades. No "Swap in next step" text.
