...
export const PROMOTIONS: Promotion[] = [
  // Term-based free months (Early Bird)
  {
    id: 'early_bird_2year',
    title: '2-Year Pact Early Bird',
  ...
  {
    id: 'prepay_2year',
    title: 'Pay Upfront (2-Year)',
    shortDescription: '15% off when you pay upfront',
    type: 'prepayPercentOff',
    stackGroup: 'percentOff',
    value: 15,
    eligibility: { term: '2-year', payUpfront: true },
    displayOrder: 3,
    active: true,
  },
  {
    id: 'prepay_1year',
    title: 'Pay Upfront (1-Year)',
    shortDescription: '10% off when you pay upfront',
    type: 'prepayPercentOff',
    stackGroup: 'percentOff',
    value: 10,
    eligibility: { term: '1-year', payUpfront: true },
    displayOrder: 4,
    active: true,
  },
...
export function applyPromotions(
  ...
  const termMonths = baseTotals.term === '2-year' ? 24 : 12;
